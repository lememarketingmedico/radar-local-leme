...
Versão V3 do Radar Local LEME com:
...
- centro do grid ajustável e arrastável no mapa;
- grid 3x3, 5x5 e 7x7;
- raio livre de 0,2 km a 50 km;
- relatório visual em PNG com identidade LEME;
...
Importante: para o relatório baixar com mapa real, ative a **Maps Static API** no Google Cloud e adicione essa API nas permissões da chave Backend. Se não ativar, o app ainda gera o relatório, mas aparece um fallback informando para ativar a API.
...
O grid usa Places API buscando IDs dos lugares. O relatório com mapa real usa Maps Static API. Monitore em Google Cloud > Faturamento > Relatórios > Agrupar por SKU.
